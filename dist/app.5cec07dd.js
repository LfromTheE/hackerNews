...
exports.CONTENTS_URL = exports.NEWS_URL = void 0;
exports.NEWS_URL = 'https://api.hnpwa.com/v0/news/1.json';
exports.CONTENTS_URL = 'https://api.hnpwa.com/v0/item/@id.json';
...
var NewsDetailView = /** @class */function (_super) {
  ...
  function NewsDetailView(containerId, store) {
    ...
    _this.render = function (id) {
      var api = new api_1.NewsDetailApi(config_1.CONTENTS_URL.replace('@id', id));
      var _a = api.getData(),
        title = _a.title,
        content = _a.content,
